...
namespace RestWidthASP.NET5.Controllers
{
    ...
    public class CalculatorController : ControllerBase
    {
        ...
        [HttpGet("mean/{firstNumber}/{secondNumer}")]
        public IActionResult Mean(string firstNumber, string secondNumer)
        {
            if (IsNumeric(firstNumber) && IsNumeric(secondNumer))
            {
                var mean = (ConvertToDecimal(firstNumber) + ConvertToDecimal(secondNumer)) / 2;
